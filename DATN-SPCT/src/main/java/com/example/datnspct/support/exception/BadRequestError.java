...
public enum BadRequestError implements ResponseError {
    ...
    IMG_NOT_EXISTED(4124124, "Image method not allowed"),
    STAFF_NOT_EXISTED(4124125, "Staff method not allowed"),
    ACCOUNT_NOT_EXISTED(4124126, "Account method not allowed"),
    CART_NOT_EXISTED(4124127, "Cart method not allowed"),
